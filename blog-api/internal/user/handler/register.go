...
// @Success      201      {object}  server.APIResponse{message=string,result=user.AuthResponse}  "User registered successfully"
// @Failure      400      {object}  server.APIResponse{message=string,error=string}              "Invalid input"
// @Failure      409      {object}  server.APIResponse{message=string,error=string}              "Email or username already exists"
